...
from support_desk.cli import demo_state
from support_desk.storage import load_state, save_state
from support_desk.models import generate_short_id
from support_desk.validation import normalize_tags, require_text, validate_task_status
from support_desk.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
